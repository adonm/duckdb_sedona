...
SQL_FILES=(tests/all_functions.sql tests/sedona_bridge.sql tests/vector_encodings.sql tests/fidelity.sql tests/edge_cases.sql tests/raster.sql tests/reference/postgis_compat.sql)
TOTAL_PASS=0
TOTAL_FAIL=0
FAILED_FILES=()
